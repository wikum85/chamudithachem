<div class="asignments_grid__search">
    ...
    <span><?php esc_html_e('Search assignment', 'masterstudy-lms-learning-management-system-pro'); ?></span>
    <input type="text" class="form-control"
           v-model="s"
           placeholder="<?php esc_attr_e('Enter assignment name', 'masterstudy-lms-learning-management-system-pro'); ?>"
           @keyup="initSearch()">
</div>
...
<div class="asignments_grid" v-bind:class="{'loading' : loading}">
    <div class="asignments_grid__single"
        ...
        <a :href="assignment.url" class="inner" v-bind:class="{'unviewed' : typeof assignment.data !=='undefined' && assignment.data.pending > assignment.data.pending_watched}">
...
<div class="asignments_grid__pagination">
