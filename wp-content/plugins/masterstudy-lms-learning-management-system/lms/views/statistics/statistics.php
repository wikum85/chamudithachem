...
$v = time();
wp_enqueue_script('stm-lms-statistics', STM_LMS_URL . '/wp-custom-fields-theme-options/metaboxes/assets/js/stm-lms-statistics.js', array('vue.js'), $v);
wp_localize_script('stm-lms-statistics', 'stm_statistics_url_data', array(
