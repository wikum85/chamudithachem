...
?>
	<div<?php echo stm_echo_safe_output($inline_css); ?> class="<?php echo esc_attr( trim( $css_class ) ); ?> clearfix">
		...
		<?php if ( $h2 != '' || $h4 != '' ): ?>
			<hgroup>
				<?php if ( $h2 != '' ): ?><h2 class="wpb_heading"><?php echo sanitize_text_field($h2); ?></h2><?php endif; ?>
				<?php if ( $h4 != '' ): ?><h4 class="wpb_heading"><?php echo sanitize_text_field($h4); ?></h4><?php endif; ?>
			</hgroup>
		<?php endif; ?>
