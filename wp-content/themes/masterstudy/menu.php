    ...
    <div class="collapse navbar-collapse pull-right">
        <ul class="header-menu clearfix">
			...
			<?php if(is_user_logged_in()){
				...
				$path = $is_instructor ? '/admin-portal/' : '/student-portal/';
				$name = $is_instructor ? 'Admin Portal' : 'Student Portal';
			?>
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5087">
					<a href="<?php echo( home_url( $path ) ); ?>"><?php echo( $name ); ?></a>
					<div class="magic_line" style="max-width: 88px;"></div>
				</li>
			<?php };?>
        </ul>
    </div>
